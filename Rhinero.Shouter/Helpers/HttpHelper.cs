...
namespace Rhinero.Shouter.Helpers
{
    ...
    {
        internal static void EnrichWithQueryParameters(StringBuilder uriBuilder, HttpPayload payload)
        {
        ...
        internal static void EnrichWithContent(HttpRequestMessage request, HttpPayload payload)
        {
            ...
            static string GetContentType(ContentTypeEnum contentType) => contentType switch
            {
        ...
        internal static void EnrichWithHeaders(HttpRequestMessage request, HttpPayload payload)
        {
        ...
        internal static void EnrichWithCredentials(HttpRequestMessage request, HttpPayload payload)
        {
        ...
        internal static void EnrichWithToken(HttpRequestMessage request, HttpPayload payload)
        {
